...
/**
 * @file        mytest/exception.hpp
 * @brief       exception class header.
 * @author      Killian Valverde
 * @date        2024/10/22
 */

#ifndef MYTEST_EXCEPTION_HPP
#define MYTEST_EXCEPTION_HPP
...
/**
 * @brief       Base interface for standard mytest exceptions. All objects thrown 
 *              by components mytest are derived from this class. Therefore, all 
 *              mytest exceptions can be caught by catching this type by reference.
 */
...
/**
 * @brief       Base class that the mytest classes will use to throw exceptions.
 */
